...
{ id: 6, title: "Breakthrough in IoT Agriculture Research", category: "Research", date: "2025-12-10", author: "Research Team", image: "images/smart-farming-smart-agriculture-iot.webp", summary: "BTRC researchers develop innovative IoT solution for smart farming, potentially revolutionizing agriculture in the region.", link: "" }
  ...
  team: [
    { id: 1, name: "Engr Ngum Cendres Kan", role: "Founder", qualifications: "MSc, MEng, MBA, BEng", image: "images/kan founder.jpeg", bio: "Engr Ngum Cendres Kan is a distinguished engineer, researcher, and entrepreneur with extensive experience in technology development and education. With advanced degrees in Engineering and Business Administration, he brings a unique blend of technical expertise and strategic vision to BTRC. His passion for technology led him to establish the Bamenda Technological Research Center to create a hub for technological advancement in Cameroon." },
    { id: 2, name: "Mr Taah Mathew", role: "Co-Founder", qualifications: "", image: "images/my stamp.jpeg", bio: "Mr Taah Mathew is a co-founder of BTRC, helping drive the center's research and innovation initiatives." }
  ]
};
